...
<body>
	<div id="myNav" class="overlay">
		  <button><a href="javascript:void(0)" class="closebtn margin_left" onclick="closeNav()">&times;</a></button>
			...
			<div class="tr_choices">
				<div class="td_choices">
					<?php 
						...
						while($value=mysqli_fetch_array($retval))
						{
						echo"<input type='radio' id='prefered_time' name='prefered_time' value='{$value[1]}'>
